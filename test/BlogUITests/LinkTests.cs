...
namespace TheWebWeWeave.BlogUITests
{
    ...
    public class LinkTests
    {
        ...
        [TestMethod]
        [TestCategory("UITest")]
        public void Linking_the_Iterations_to_all_your_Teams_Was_Deployed()
        {
            string post = "Linking the Iterations to all your Teams";
            HomePage.Goto();
            HomePage.GoToPost(post);
            Assert.IsTrue(HomePage.PostFound(post), String.Format("The post \"{0}\" was not found", post));
        }
        ...
        [TestMethod]
        [TestCategory("UITest")]
        public void Linking_WorkItems_To_Commits_Was_Deployed()
        {
            string post = "Linking WorkItems to Commits";
            HomePage.Goto();
            HomePage.GoToPost(post);
            Assert.IsTrue(HomePage.PostFound(post), $"The post \"{post}\" was not found");
        }
        ...
        [TestMethod]
        [TestCategory("UITest")]
        public void How_I_Work_With_Work_Item_Templates_Was_Deployed()
        {
            string post = "How I Work With Work Item Templates";
            HomePage.Goto();
            HomePage.GoToPost(post);
            Assert.IsTrue(HomePage.PostFound(post), $"The post \"{post}\" was not found");
        }
